...
* File Compiled:  homework_7/UnitTests_KL/i00.tm
* =================================================
* 
* START FUNC INPUT
...
* LOFF Line188: -3
* START COMPOUND BODY
 40:    LDC  3,666(6)	Load int const 
 41:     ST  3,-2(1)	Store Var i
* START CALL output
...
* START INIT
 53:    LDA  1,0(0)	Set first frame after globals 
