...
* File Compiled:  homework_7/UnitTests_KL/g08.tm
* =================================================
* 
* START FUNC INPUT
...
* END CALL
* LOFF Line749: -15
 87:     ST  3,-15(1)	Push parameter 623 
* LOFF Line615: -16
* END Param 1
 88:    LDA  1,-13(1)	Ghost frame becomes new active frame 
 89:    LDA  3,1(7)	Load return addr 
* BackPatch 90
...
* 
* =========================================================
  0:    JMP  7,95(7)	Jump to init 
* START INIT
 96:    LDA  1,0(0)	Set first frame after globals 
 97:     ST  1,0(1)	Store old fp 
* START INIT GLOBALS AND STATICS
* END INIT GLOBALS AND STATICS
 98:    LDA  3,1(7)	Load return address 
